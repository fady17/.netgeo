...
namespace AutomotiveServices.Api.Migrations
{
    ...
    [Migration("20250617160751_AddAdminAreaShopStatsTable")]
    partial class AddAdminAreaShopStatsTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AutomotiveServices.Api.Models.AdminAreaShopStats", b =>
                {
                    b.Property<int>("AdministrativeBoundaryId")
                    ...
                    b.HasKey("AdministrativeBoundaryId");

                    b.HasIndex("LastUpdatedAtUtc");

                    b.ToTable("AdminAreaShopStats");
                });

            modelBuilder.Entity("AutomotiveServices.Api.Models.AdministrativeBoundary", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<Geometry>("SimplifiedBoundary")
                        .HasColumnType("geography(MultiPolygon, 4326)");
                    ...
                    b.HasIndex("SimplifiedBoundary");

                    NpgsqlIndexBuilderExtensions.HasMethod(b.HasIndex("SimplifiedBoundary"), "GIST");

                    b.ToTable("AdministrativeBoundaries");
                });
            ...
            modelBuilder.Entity("AutomotiveServices.Api.Models.Booking", b =>
                {
                    ...
                    b.Property<string>("PreferredDateTimeNotes")
                        .HasMaxLength(1000)
                    ...
                    b.Property<string>("UserContactPhoneNumber")
                        .HasMaxLength(500)
                        .HasColumnType("character varying(500)");
                    ...
                    b.HasIndex("ShopId")
                        .HasDatabaseName("IX_Bookings_ShopId");
            ...
            modelBuilder.Entity("AutomotiveServices.Api.Models.BookingItem", b =>
                {
                    ...
                    b.HasIndex("ShopServiceId")
                        .HasDatabaseName("IX_BookingItems_ShopServiceId");
            ...
            modelBuilder.Entity("AutomotiveServices.Api.Models.OperationalArea", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<Geometry>("CustomBoundary")
                        .HasColumnType("geography(MultiPolygon, 4326)");

                    b.Property<Geometry>("CustomSimplifiedBoundary")
                        .HasColumnType("geography(MultiPolygon, 4326)");

                    b.Property<int?>("DefaultMapZoomLevel")
                        .HasColumnType("integer");

                    b.Property<double?>("DefaultSearchRadiusMeters")
                        .HasColumnType("double precision");
                    ...
                    b.Property<int?>("PrimaryAdministrativeBoundaryId")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("CustomBoundary");

                    NpgsqlIndexBuilderExtensions.HasMethod(b.HasIndex("CustomBoundary"), "GIST");

                    b.HasIndex("CustomSimplifiedBoundary");

                    NpgsqlIndexBuilderExtensions.HasMethod(b.HasIndex("CustomSimplifiedBoundary"), "GIST");

                    b.HasIndex("IsActive");

                    b.HasIndex("PrimaryAdministrativeBoundaryId");
            ...
            modelBuilder.Entity("AutomotiveServices.Api.Models.Shop", b =>
                {
                    ...
                    b.HasIndex("OperationalAreaId")
                        .HasDatabaseName("IX_Shops_OperationalAreaId");

                    b.HasIndex("OperationalAreaId", "Slug")
                        .IsUnique()
                        .HasDatabaseName("IX_Shops_OperationalAreaId_Slug")
                        .HasFilter("\"Slug\" IS NOT NULL");

                    b.HasIndex("OperationalAreaId", "Category", "IsDeleted")
            ...
            modelBuilder.Entity("AutomotiveServices.Api.Models.ShopDetailsView", b =>
                {
                    ...
                    b.Property<string>("OperationalAreaNameAr")
                        .IsRequired()
                        .HasMaxLength(150)
                        .HasColumnType("character varying(150)");

                    b.Property<string>("OperationalAreaNameEn")
                        .IsRequired()
                        .HasMaxLength(150)
                        .HasColumnType("character varying(150)");

                    b.Property<string>("OperationalAreaSlug")
                        .IsRequired()
                        .HasMaxLength(150)
                        .HasColumnType("character varying(150)");
            ...
            modelBuilder.Entity("AutomotiveServices.Api.Models.UserCartItem", b =>
                {
                    b.Property<Guid>("UserCartItemId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("UserId")
                        .HasDatabaseName("IX_UserCartItems_UserId");

                    b.HasIndex("UserId", "ShopId", "ShopServiceId")
                        .IsUnique()
            ...
            modelBuilder.Entity("AutomotiveServices.Api.Models.UserPreference", b =>
                {
            ...
            modelBuilder.Entity("AutomotiveServices.Api.Models.AdminAreaShopStats", b =>
                {
                    b.HasOne("AutomotiveServices.Api.Models.AdministrativeBoundary", "AdministrativeBoundary")
                        .WithOne()
                        .HasForeignKey("AutomotiveServices.Api.Models.AdminAreaShopStats", "AdministrativeBoundaryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("AdministrativeBoundary");
                });

            modelBuilder.Entity("AutomotiveServices.Api.Models.AdministrativeBoundary", b =>
                {
                    b.HasOne("AutomotiveServices.Api.Models.AdministrativeBoundary", "Parent")
                        .WithMany("Children")
            ...
            modelBuilder.Entity("AutomotiveServices.Api.Models.BookingItem", b =>
                {
                    b.HasOne("AutomotiveServices.Api.Models.Booking", "Booking")
            ...
            modelBuilder.Entity("AutomotiveServices.Api.Models.OperationalArea", b =>
                {
                    b.HasOne("AutomotiveServices.Api.Models.AdministrativeBoundary", "PrimaryAdministrativeBoundary")
                        .WithMany()
                        .HasForeignKey("PrimaryAdministrativeBoundaryId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.Navigation("PrimaryAdministrativeBoundary");
                });

            modelBuilder.Entity("AutomotiveServices.Api.Models.Shop", b =>
                {
                    b.HasOne("AutomotiveServices.Api.Models.OperationalArea", "OperationalArea")
                        .WithMany("Shops")
